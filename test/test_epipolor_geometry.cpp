...
int main(int argc, char **argv)
{
    ...
    }else{ // use settings in .yaml file
    ...
    for (int j=0; j<num_solutions;j++){
        ...
        if (num_pts==0)err_triang=9999999999;
        else err_triang=sqrt(err_triang/num_pts);
